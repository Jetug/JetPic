...
fun Context.getDirsToShow(dirs: ArrayList<Directory>, allDirs: ArrayList<Directory> = arrayListOf(), currentPathPrefix: String = ""): ArrayList<FolderItem>{
    ...
    if (config.groupDirectSubfolders) {
        ...
        if (currentPathPrefix.isNotEmpty() && allDirs.isNotEmpty()) {
...
//Jet
private fun Context.getComparator(): (FolderItem, FolderItem) -> Int = when {
    sorting and SORT_BY_NAME          != 0 -> ::byName
    sorting and SORT_BY_PATH          != 0 -> ::byPath
    sorting and SORT_BY_SIZE          != 0 -> ::bySize
    sorting and SORT_BY_DATE_MODIFIED != 0 -> ::byDateModified
    else -> ::byDateTaken
}

private fun Context.byName(o1: FolderItem, o2: FolderItem): Int =
...
private fun Context.byPath(o1: FolderItem, o2: FolderItem): Int =
    if (sorting and SORT_USE_NUMERIC_VALUE != 0)
        AlphanumericComparator().compare(o1.path.toLowerCase(), o2.path.toLowerCase())
    else
        o1.path.toLowerCase().compareTo(o2.path.toLowerCase())

private fun bySize(o1: FolderItem, o2: FolderItem): Int = (o1.size).compareTo(o2.size)

private fun byDateModified(o1: FolderItem, o2: FolderItem): Int = (o1.modified).compareTo(o2.modified)

private fun byDateTaken(o1: FolderItem, o2: FolderItem): Int = (o1.taken).compareTo(o2.taken)
