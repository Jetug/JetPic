package com.simplemobiletools.gallery.pro.data.databases
...
@Database(entities = [Directory::class, Medium::class, Widget::class, DateTaken::class, Favorite::class, FolderSettings::class], version = 13)
