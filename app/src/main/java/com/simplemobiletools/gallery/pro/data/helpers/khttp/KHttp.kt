...
package com.simplemobiletools.gallery.pro.data.helpers.khttp

import kotlin.concurrent.thread

import com.simplemobiletools.gallery.pro.data.helpers.khttp.requests.GenericRequest
import com.simplemobiletools.gallery.pro.data.helpers.khttp.responses.GenericResponse
import com.simplemobiletools.gallery.pro.data.helpers.khttp.responses.Response
import com.simplemobiletools.gallery.pro.data.helpers.khttp.structures.authorization.Authorization
import com.simplemobiletools.gallery.pro.data.helpers.khttp.structures.files.FileLike
import javax.net.ssl.HostnameVerifier
import javax.net.ssl.SSLContext
import com.simplemobiletools.gallery.pro.data.helpers.khttp.*
...
class async {
    companion object {
        ...
        fun request(method: String, url: String, headers: Map<String, String> = mapOf(), params: Map<String, String> = mapOf(), data: Any? = null, json: Any? = null, auth: Authorization? = null, cookies: Map<String, String>? = null, timeout: Double = DEFAULT_TIMEOUT, allowRedirects: Boolean? = null, stream: Boolean = false, files: List<FileLike> = listOf(), sslContext: SSLContext? = null, hostnameVerifier: HostnameVerifier? = null, onError: Throwable.() -> Unit = { throw this }, onResponse: Response.() -> Unit = {}): Unit {
            thread {
                try {
                    onResponse(com.simplemobiletools.gallery.pro.data.helpers.khttp.request(method, url, headers, params, data, json, auth, cookies, timeout, allowRedirects, stream, files, sslContext, hostnameVerifier))
                } catch (e: Throwable) {
                    onError(e)
                }
            }
